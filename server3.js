...
app.post('/getTopEntries', async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`${fragment_1}/manualGetTopEntries`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/getCount', async (req, res) => {
    ...
    try {
        ...
        console.log(`Error: fragment2 request failed`)
    }
    ...
    try {
        console.log("Attempting fragment1 server...")
        const response = await fetch(`${fragment_1}/manualGetCount`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/deleteEntry', async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`${fragment_1}/manualDeleteEntry`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/getSingleGame', async (req, res) => {
    ...
    try {
        ...
        console.log("Game not found in fragment2");
        throw new Error("Game not found on fragment2");
    } catch (err) {
        console.log("Fragment2 failed, trying fragment1...");
    }

    // Attempt fragment1 server
    try {
        const response = await fetch(`${fragment_1}/getSingleGame`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (!response.ok) {
            throw new Error("Fragment1 server request failed");
        }
...
app.post('/updateEntry', async (req, res) => {
    ...
    try {
        ...
        console.log("Deleting from fragment 1")
        await fetch(`${fragment_1}/manualDeleteEntry`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (new_year >= 2020) {
            ...
            await fetch(`${fragment_1}/insertEntry`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
app.post('/search', async (req, res) => {
    ...
    try {
        ...
        fragment_1_results = await response.json()
